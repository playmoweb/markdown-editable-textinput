...
void main() {
  group("test all convertToMarkdown function's cases", () {
    ...
    test('convert to bold from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to italic from to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to strikethrough from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H1 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H2 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H3 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H4 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H5 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to H6 from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    // test('convert to List from right to left', () {
    //   var testString =
    //       'Lorem ipsum\ndolor sit amet\nconsectetur adipiscing elit.';
    //   var from = testString.length;
    //   var to = 0;
    ...
    test('convert to code from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
    ...
    test('convert to image from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet consectetur adipiscing elit.';
      var from = 12;
      var to = 17;
    ...
    test('convert to separator from right to left', () {
      var testString = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.';
      var from = 17;
      var to = 12;
